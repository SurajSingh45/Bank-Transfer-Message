 ...
 */
package com.surajsingh.banktransfermessage;
...
public class messageTransfer extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(messege.length() == 0 && (HDFCbtn.isSelected() != true || ICICIbtn.isSelected() != true)){
            JOptionPane.showMessageDialog(null, "Select Required Option.");
        }
        else if(ICICIbtn.isSelected() == true){
            ICICI ic = new ICICI();
                  //sauravhathi
